(function (String, angular) {
  ...
  //application-wide logic
    pbm.controller("BaseCtrl", ['$rootScope', '$scope', '$window', '$state','$transitions', 'pb','pbui' ,'$translate','$log', 'App_Dict', 'App_MenuData','App_FuncTree','APP_ContextPrefix',
                                function ($rootScope, $scope, $window, $state,$transitions, pb,pbui, $translate,$log, App_Dict, App_MenuData,App_FuncTree,APP_ContextPrefix) {
    	var c = this;
